...
async function openWebPage(){ // declaramos una funcion asincrona 
    ...
    await page.type('#login-username','santiago.gallego1@utp.edu.co'); // buscamos el id del input del username, posteriormente proporcionamos el username
    await page.type('#login-password','Dualshock2274');// buscamos el id del input del password, posteriormente proporcionamos el password
